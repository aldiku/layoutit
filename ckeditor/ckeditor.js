...
(function () {
  ...
  CKEDITOR.env ||
    (CKEDITOR.env = (function () {
      ...
      if (b.gecko)
        if (f < 10900) b.cssClass = b.cssClass + " cke_browser_gecko18";
      ...
      extend: function (b) {
        ...
        for (var c = 1; c < a; c++) {
          var l = arguments[c],
            i;
          for (i in l)
            if (e === true || b[i] == void 0) if (!d || i in d) b[i] = l[i];
        }
        return b;
      },
  ...
  CKEDITOR.dtd = (function () {
    var a = CKEDITOR.tools.extend,
      c = function (b, a) {
        for (
          var f = CKEDITOR.tools.clone(b), c = 1;
          c < arguments.length;
          c++
        ) {
          var a = arguments[c],
      ...
      on: function (c) {
        ...
        if (!b[c]) {
          ...
          this.$.addEventListener
            ? this.$.addEventListener(c, b, !!CKEDITOR.event.useCapture)
            : this.$.attachEvent && this.$.attachEvent("on" + c, b);
        }
        ...
        if (!this.hasListeners(a)) {
          ...
          if (f) {
            this.$.removeEventListener
              ...
              : this.$.detachEvent && this.$.detachEvent("on" + a, f);
            delete b[a];
          }
        }
      },
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getAddress: function (a) {
      for (
        var c = [], b = this.getDocument().$.documentElement, f = this.$;
        f && f != b;
    ...
    getPreviousSourceNode: function (a, c, b) {
      ...
      return !a || (b && b(a) === false)
        ? null
        : c && a.type != c
        ? a.getPreviousSourceNode(false, c, b)
        : a;
    },
    ...
    getParent: function (a) {
      ...
      return c &&
        (c.nodeType == CKEDITOR.NODE_ELEMENT ||
          (a && c.nodeType == CKEDITOR.NODE_DOCUMENT_FRAGMENT))
        ? new CKEDITOR.dom.node(c)
        : null;
    },
    ...
    getPosition: function (a) {
      ...
      if (
        ...
        if ("sourceIndex" in c)
          return c.sourceIndex < 0 || b.sourceIndex < 0
  ...
  (function () {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      appendText: function (b) {
        this.$.text != void 0
          ...
          : this.append(new CKEDITOR.dom.text(b));
      },
      appendBogus: function () {
        for (
          ...
          !CKEDITOR.tools.rtrim(b.getText());
          ...
          ? function (b) {
              switch (b) {
                ...
                case "checked":
                  ...
                  return (b.specified ? b.nodeValue : this.$.checked)
                    ? "checked"
                    : null;
                case "hspace":
                case "value":
      ...
      isEditable: function (b) {
        ...
        if (
          ...
          CKEDITOR.dtd.$nonEditable[a] ||
          CKEDITOR.dtd.$empty[a] ||
          (this.is("a") &&
      ...
      hasAttributes:
        CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat)
          ...
          : function () {
              ...
              return (
                a > 0 &&
                (a > 2 || !c[b[0].nodeName] || (a == 2 && !c[b[1].nodeName]))
              );
            },
        ...
        return CKEDITOR.env.ie &&
          ...
          ? function (b) {
              b == "class"
                ...
                : b == "tabindex"
                ? (b = "tabIndex")
                : b == "contenteditable" && (b = "contentEditable");
              this.$.removeAttribute(b);
            }
          : b;
      })(),
      removeAttributes: function (b) {
        if (CKEDITOR.tools.isArray(b))
          for (var a = 0; a < b.length; a++) this.removeAttribute(b[a]);
      ...
      unselectable: function () {
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.opera) {
          ...
          for (
            var b, a = this.getElementsByTag("*"), c = 0, d = a.count();
            c < d;
            c++
          ) {
            b = a.getItem(c);
      ...
      getDocumentPosition: function (b) {
        ...
        if (b) {
          ...
          if (!j.equals(d) && j.$.frameElement) {
            b = new CKEDITOR.dom.element(j.$.frameElement).getDocumentPosition(
              b
            );
            a = a + b.x;
            c = c + b.y;
      ...
      scrollIntoView: function (b) {
        ...
        if (a) {
          do {
            ((a.$.clientWidth && a.$.clientWidth < a.$.scrollWidth) ||
              (a.$.clientHeight && a.$.clientHeight < a.$.scrollHeight)) &&
              !a.is("body") &&
              this.scrollIntoParent(a, b, 1);
            if (a.is("html")) {
              var c = a.getWindow();
              try {
      ...
      scrollIntoParent: function (b, a, c) {
        ...
        b instanceof CKEDITOR.dom.window &&
          (b = p ? l.getBody() : l.getDocumentElement());
        l = b.getWindow();
        j = n(this, l);
        var g = n(b, l),
          h = this.$.offsetHeight;
        ...
        for (var c = this.$.attributes, a = a || {}, d = 0; d < c.length; d++) {
          ...
          if (!(l in a))
            if (l == "checked" && (i = this.getAttribute(l)))
              ...
              j.specified ||
              (CKEDITOR.env.ie && j.nodeValue && l == "value")
            ) {
      ...
      disableContextMenu: function () {
        this.on("contextmenu", function (b) {
          b.data.getTarget().hasClass("cke_enable_context_menu") ||
    ...
    CKEDITOR.dom.element.prototype.getSize = function (b, c) {
      var e =
        Math.max(
          this.$["offset" + CKEDITOR.tools.capitalize(b)],
          this.$["client" + CKEDITOR.tools.capitalize(b)]
        ) || 0;
      c && (e = e - a.call(this, b));
      return e;
    };
  ...
  (function () {
          ...
          d.type == CKEDITOR.NODE_ELEMENT &&
            (d =
              p > 0
                ...
                : g(d, true) === false
                ? null
                : d.getPreviousSourceNode(true, u, g));
        else {
          d = n;
    ...
    CKEDITOR.dom.element.prototype.isBlockBoundary = function (a) {
      a = a
        ? CKEDITOR.tools.extend({}, CKEDITOR.dtd.$block, a || {})
        : CKEDITOR.dtd.$block;
      return (
  ...
  (function () {
    function a() {
      ...
      return function (h) {
        ...
        return (h.type == CKEDITOR.NODE_TEXT &&
          (h.hasAscendant("pre") || CKEDITOR.tools.trim(h.getText()).length)) ||
          (h.type == CKEDITOR.NODE_ELEMENT && !h.is(d))
          ? false
          : true;
      };
    }
      ...
      e = function (a, b, c, g) {
        ...
        if (b == 2) {
          ...
          if (
            i &&
            q &&
            (h.$.parentNode != i.$.parentNode ||
              d.$.parentNode != q.$.parentNode)
          ) {
            b = q.getIndex();
    ...
    CKEDITOR.dom.range.prototype = {
        ...
        if (a) {
          if (b.type == CKEDITOR.NODE_ELEMENT) {
            if (
              ...
              g > 0 &&
              f.getPrevious().type == CKEDITOR.NODE_TEXT
            ) {
              b = f;
              g = 0;
            }
      ...
      enlarge: function (a, b) {
        switch (a) {
                  ...
                  if (e.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (l && CKEDITOR.dtd.$removeEmpty[e.getName()]) {
                      ...
                      if (/[^\s\ufeff]/.test(q)) e = null;
                        ...
                        for (
                          var m = e.$.getElementsByTagName("*"), s = 0, A;
                          (A = m[s++]);
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var v,
              o,
              x = CKEDITOR.dom.walker.blockBoundary(
            ...
            this.setStartAt(
              v,
              !v.is("br") &&
                ((!k && this.checkStartOfBlock()) || (k && v.contains(k)))
            ...
            this.setEndAt(
              v,
              (!k && this.checkEndOfBlock()) || (k && v.contains(k))
      ...
      shrink: function (a, b, c) {
        if (!this.collapsed) {
          ...
          if (j)
            (h = g[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) &&
              this.setStartAt(
                h,
                b
                  ? CKEDITOR.POSITION_AFTER_START
      ...
      moveToElementEditablePosition: function (a, c) {
        ...
        for (var d = 0; a; ) {
          if (a.type == CKEDITOR.NODE_TEXT) {
            c && this.checkEndOfBlock() && m.test(a.getText())
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          i.enlarge(
            (this.forceBrBreak && !n) || !this.enlargeBr
          ...
          if (!i.collapsed) {
            ...
            if (
              ...
              if (g.checkEndOfBlock()) {
                ...
                this._.lastNode = (g.block || g.blockLimit).getNextSourceNode(
                  true
                );
              }
            }
        ...
        if (!e) {
          ...
          if (
            ...
            this._.nextNode = e.equals(n)
              ? null
              : c(i.getBoundaryNodes().endNode, 1, n);
        }
        if (r)
          (i = e.getPrevious()) &&
        ...
        if (p)
          (i = e.getLast()) &&
            ...
            i.remove();
        if (!this._.nextNode)
          this._.nextNode = m || e.equals(n) || !n ? null : c(e, 1, n);
        return e;
      },
    };
  ...
  (function () {
    ...
    function g(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || D.$block[a.name])
      );
    }
    function h(a, b, c) {
      var d = a.name;
      if (D.$empty[d] || !a.children.length)
        ...
        if (b == "br") {
          ...
          if (h) {
            ...
            for (
              var e =
                  h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || h.name == "body",
                j,
                f = d.length;
              f > 0;
              ...
              if (
                e &&
                (k.type == CKEDITOR.NODE_TEXT ||
                  (k.type == CKEDITOR.NODE_ELEMENT && D.$inline[k.name]))
              ) {
                if (!j) {
    ...
    CKEDITOR.filter.prototype = {
      ...
      applyTo: function (a, b, c) {
          ...
          function (a) {
            if (a.type == CKEDITOR.NODE_ELEMENT) {
              ...
              a: {
                ...
                h.children.length == 1 &&
                  (f = h.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                  k(f, g, e, c, b);
                c = !c.length;
              }
              c || d.push(a);
        ...
        d.length && (u = true);
        for (
          var o, p, a = [], c = ["p", "br", "div"][this.enterMode - 1];
          (o = d.pop());
        ...
        for (; (p = a.pop()); ) {
          ...
          if (o.parent)
            switch (p.check) {
              case "it":
                D.$removeEmpty[o.name] && !o.children.length
                  ? h(o, c, a)
                  : n(o) || h(o, c, a);
                break;
              case "el-up":
                o.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                  !D[o.parent.name][o.name] &&
                  h(o, c, a);
                break;
              case "parent-down":
                o.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
      ...
      check: function (a, b, c) {
        ...
        b =
          o.length > 0
            ? false
            : CKEDITOR.tools.objectCompare(g.attributes, k.attributes, true)
            ? true
            : false;
  ...
  CKEDITOR.resourceManager.prototype = {
    ...
    addExternal: function (a, c, b) {
      for (var a = a.split(","), f = 0; f < a.length; f++)
        this.externals[a[f]] = { dir: c, file: b };
    },
    load: function (a, c, b) {
      CKEDITOR.tools.isArray(a) || (a = a ? [a] : []);
      for (
        var f = this.loaded, e = this.registered, d = [], j = {}, l = {}, i = 0;
        i < a.length;
        i++
      ) {
        var m = a[i];
  ...
  (function () {
    function a(a, d, g) {
      ...
      if (d !== void 0) {
        ...
        if (
          (g == CKEDITOR.ELEMENT_MODE_INLINE &&
            !d.is(CKEDITOR.dtd.$editable)) ||
          (g == CKEDITOR.ELEMENT_MODE_REPLACE &&
    ...
    function d(a) {
      ...
      if (c.fn) {
        ...
        (CKEDITOR.getUrl(a.config.customConfig) == b || !d(a)) &&
        ...
        for (var k in c) {
          ...
          if (o && !a.lang[k]) {
            ...
            if (CKEDITOR.tools.indexOf(o, a.langCode) >= 0) p = a.langCode;
              ...
              p =
                p != a.langCode && CKEDITOR.tools.indexOf(o, p) >= 0
                  ? p
          ...
          for (
            ...
            for (var k = 0; k < d.length; k++) {
              ...
              e === 0 &&
                ...
                f.lang &&
                f.langEntries &&
                (a.lang[f.name] = f.langEntries[g[k]]);
              if (f[c[e]]) f[c[e]](a);
            }
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (e, d, j) {
      ...
      var g = new CKEDITOR.htmlParser(),
        h =
          d instanceof CKEDITOR.htmlParser.element
            ? d
            : typeof d == "string"
        ...
        if (a(e)) u.push(e);
          ...
          if (d == "br") w.push(e);
            ...
            for (;;) {
              j = (h = k.name)
                ? CKEDITOR.dtd[h] ||
                  (k._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                : f;
              if (!e.isUnknown && !k.isUnknown && !j[d])
                if (k.isOptionalClose) g.onTagClose(h);
                else if (d in b && h in b) {
                  h = k.children;
                  ((h = h[h.length - 1]) && h.name == "li") ||
                    n((h = new CKEDITOR.htmlParser.element("li")), k);
    ...
    function p(a) {
      return a.replace(o, function (a, b, c) {
        return (
          "<" +
          b +
          c.replace(x, function (a, b) {
            return !/^on/.test(b) && c.indexOf("data-cke-saved-" + b) == -1
    ...
    function t(a, b) {
      ...
      a = a.replace(e, function (a, b, g) {
        return (
          ...
          D +
          (b ? "{C}" : "") +
          encodeURIComponent(c[g]).replace(/--/g, "%2D%2D") +
          "-->"
        );
      });
      ...
      b.on(
        ...
        function (a) {
          ...
          a.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(
            d,
            a.context,
            a.fixForBody === false ? false : c(b.config)
          );
        },
        null,
        null,
  ...
  (function () {
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (b in CKEDITOR.dtd.$editable)
        for (
          var f = CKEDITOR.document.getElementsByTag(b), e = 0, d = f.count();
          e < d;
          e++
        ) {
          a = f.getItem(e);
  ...
  (function () {
    function a(a, e, l, i) {
      ...
      m.on("loaded", function () {
        b(m);
        i == CKEDITOR.ELEMENT_MODE_REPLACE &&
          m.config.autoUpdateElement &&
          f(m);
    ...
    function b(a) {
      ...
      f &&
        a.ui.space("contents").setStyle("height", CKEDITOR.tools.cssLength(f));
      ...
      if (a.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE && b.is("textarea")) {
        ...
        if (c) {
          ...
          if (!c.$.submit.nodeName && !c.$.submit.length)
            c.$.submit = CKEDITOR.tools.override(c.$.submit, function (b) {
              return function () {
                a.updateElement();
    ...
    CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
      ...
      n.setStyle(
        "height",
        Math.max(
          b - (c ? 0 : (e.$.offsetHeight || 0) - (n.$.clientHeight || 0)),
          0
        ) + "px"
      );
      r && (r.style.width = "100%");
  ...
  (function () {
    function a(a) {
      ...
      if (
        ...
        if (
          !d.checkForward() ||
          (g.checkStartOfBlock() && g.checkEndOfBlock())
        ) {
          c = f.fixBlock(
            true,
          ...
          for (
            ...
            if (!m.checkReadOnly()) {
              ...
              if (k)
                for (
                  ;
                  (q = m.getCommonAncestor(0, 1)) &&
                  (z = CKEDITOR.dtd[q.getName()]) &&
                  (!z || !z[i]);
              ...
              if (c in { 8: 1, 46: 1 }) {
                ...
                if ((d = e(d))) {
                  ...
                  if (
                    ...
                    h.blockLimit &&
                    h.blockLimit.is("td") &&
                    (p = h.blockLimit.getAscendant("table")) &&
                    b.checkBoundaryOfElement(
                      p,
                      c ? CKEDITOR.START : CKEDITOR.END
                    ) &&
                    (j = p[c ? "getPrevious" : "getNext"](i))
                  ) {
                    a.fire("saveSnapshot");
                    b["moveToElementEdit" + (c ? "End" : "Start")](j);
    ...
    var n = (function () {
      ...
      function f(b, c, d, g) {
        ...
        if (
          (h = new CKEDITOR.dom.walker(e).next()) &&
          a(h) &&
          m[h.getName()] &&
          (k = h.getPrevious()) &&
          a(k) &&
          !k.getParent().equals(b.startContainer) &&
          d.contains(k) &&
          g.contains(h) &&
          h.isIdentical(k)
        ) {
      ...
      return function (m, q, t) {
        ...
        if (!A.checkReadOnly()) {
          var o =
              new CKEDITOR.dom.elementPath(A.startContainer, A.root)
                .blockLimit || A.root,
            q = {
              type: q,
              dontFilter: v,
          ...
          x = s.createBookmark();
          (o = x.startNode.getPrevious(b)) && a(o) && e(o) && v.push(o);
            ...
            for (i(I, E); x < I.length; x++) {
              ...
              if (y) v = x > 0;
                ...
                if (
                  !G.isBlock &&
                  (N =
                    q.editor.config.enterMode != CKEDITOR.ENTER_BR &&
                    q.editor.config.autoParagraph !== false
                      ? q.editor.config.enterMode == CKEDITOR.ENTER_DIV
                        ? "div"
                        : "p"
                      : false) &&
                  !y.block &&
                ...
                if (G.lastNotAllowed && x < I.length - 1) {
                  (O = Q ? o : O) &&
                    E.setEndAt(O, CKEDITOR.POSITION_AFTER_START);
                  s = 0;
                }
                E.collapse();
              }
  ...
  (function () {
    ...
    CKEDITOR.on("instanceCreated", function (b) {
      ...
      e.on("contentDom", function () {
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.opera || p) {
          ...
          n
            ? f.attachListener(f, "beforedeactivate", r, null, null, -1)
            : f.attachListener(e, "selectionCheck", r, null, null, -1);
          f.attachListener(
            f,
            "blur",
            function () {
            ...
            if (CKEDITOR.env.version > 7) {
              ...
              var A = function () {
                ...
                var a = CKEDITOR.document.$.selection,
                  c = a.createRange();
                a.type != "None" &&
                  c.parentElement().ownerDocument == b.$ &&
                  c.select();
              };
            }
          }
        ...
        if (
          p ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera
        ) {
          var v;
          f.attachListener(f, "mousedown", function () {
            v = 1;
          ...
          f.attachListener(
            CKEDITOR.env.ie ? f : b.getDocumentElement(),
            "mouseup",
            c,
            e
          );
        ...
        b.on(
          ...
          function () {
            var a = b.editable(),
              c = e(a);
            c &&
              (c.getCustomData("ready") ? d(a) : c.setCustomData("ready", 1));
          },
          null,
          null,
          -1
    ...
    CKEDITOR.dom.selection = function (a) {
      ...
      if (CKEDITOR.env.webkit) {
        ...
        if (
          (a.type == "None" && this.document.getActive().equals(this.root)) ||
      ...
      if (a)
        if (a.getRangeAt)
          e =
            (c = a.rangeCount && a.getRangeAt(0)) &&
            new CKEDITOR.dom.node(c.commonAncestorContainer);
        else {
          try {
            c = a.createRange();
          } catch (f) {}
          e =
            ...
            CKEDITOR.dom.element.get(
              (c.item && c.item(0)) || c.parentElement()
            );
        }
        ...
        : function () {
            ...
            if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
              ...
              if (
                ...
                r[d.childNodes[c.startOffset].nodeName.toLowerCase()]
              )
                  ...
                  for (var d = [], e = 0; e < c.length; e++) {
                    for (
                      var g = c.item(e),
                        ...
                        i = 0,
                        a = new CKEDITOR.dom.range(this.root);
                      i < f.childNodes.length && f.childNodes[i] != g;
                      i++
                    );
              ...
              if (!f.collapsed) {
                if (f.startContainer.isReadOnly())
                  for (var b = f.startContainer, i; b; ) {
                    if (
                      ((i = b.type == CKEDITOR.NODE_ELEMENT) && b.is("body")) ||
                      !b.isReadOnly()
                    )
                      break;
                    i &&
                ...
                i &&
                  ...
                  (m ? l.setEndAfter(i) : l.setEndBefore(i));
          ...
          if (this.isLocked) {
            ...
            if (n) {
              ...
              ((b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                b.startContainer.getName() in i) ||
                (b.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                  b.endContainer.getName() in i)) &&
              ...
              if (q) {
                ...
                k =
                  !(k && k.getText && k.getText().match(e)) &&
                  (j ||
                    !i.hasPrevious() ||
                    (i.getPrevious().is && i.getPrevious().is("br")));
              ...
              for (e = 0; e < a.length; e++) {
                ...
                if (
                  ...
                  if (
                    (!j && !c && k.is(CKEDITOR.dtd.$removeEmpty)) ||
    ...
    if (!b) {
      ...
      this.on("selectionChange", function (a) {
        for (var c = 0; c < b.length; c++) {
          var d = b[c],
            j = d.style.checkActive(a.data.path)
  ...
  (function () {
          ...
          if (l.equals(m)) {
            ...
            if (
              ...
              if (
                ...
                if (
                  q == CKEDITOR.NODE_TEXT ||
                  r ||
                  (q == CKEDITOR.NODE_ELEMENT && !l.getChildCount())
                ) {
                  for (
                    var q = l, w;
                    (g = !q.getNext(A)) &&
                    ((w = q.getParent()), i[w.getName()]) &&
                    (w.getPosition(k) |
                      CKEDITOR.POSITION_FOLLOWING |
                      CKEDITOR.POSITION_IDENTICAL |
                      CKEDITOR.POSITION_IS_CONTAINED) ==
      ...
      if (a.collapsed) {
        for (
          var d = new CKEDITOR.dom.elementPath(c.getParent(), a.root),
            ...
            f = 0,
            h;
          f < d.elements.length && (h = d.elements[f]);
          f++
        ) {
          ...
          if (this.checkElementRemovable(h)) {
            ...
            if (
              ...
              h.mergeSiblings();
              h.getName() == this.element
                ? r.call(this, h)
                : g(h, t(this)[h.getName()]);
            }
          }
        }
        if (e) {
    ...
    function r(a) {
      ...
      for (var i in b)
        if (
          !(this._.definition.fullMatch && a.getStyle(i) != F(i, b[i], true))
        ) {
          e = e || !!a.getStyle(i);
          a.removeStyle(i);
        }
    ...
    function p(a) {
      for (
        var b = t(this), c = a.getElementsByTag(this.element), d = c.count();
        --d >= 0;
              ...
              if (j)
                for (var m = 0; a[d + m + 1]; ) {
                  for (
                    var n = l.document,
                      j = 0,
                      i = n.getById(e[m].endNode),
                      n = n.getById(e[m + 1].startNode);
                    ;
...
*/
  ...
  (function () {
      ...
      if (CKEDITOR.env.ie && !CKEDITOR.env.ie6Compat) {
        var d = CKEDITOR.env.isCustomDomain(),
          d =
            ...
            encodeURIComponent(
              "document.open();" +
                (d ? 'document.domain="' + document.domain + '";' : "") +
                "document.close();"
            ) +
            "}())";
    ...
    function U(a) {
      function b(b) {
        ...
        a.move(
          d.x + k[3] < f
            ? -k[3]
            : d.x - k[1] > h.width - c.width - f
            ? h.width - c.width + ("rtl" == g.lang.dir ? 0 : k[1])
            : d.x,
          d.y + k[0] < f
            ? -k[0]
            : d.y - k[2] > h.height - c.height - f
        ...
        if (CKEDITOR.env.ie6Compat) {
          ...
          g.push(
            "void((function(){document.open();" +
              (k ? "document.domain='" + document.domain + "';" : "") +
              "document.write( '" +
              e +
              "' );document.close();})())"
          );
    ...
    var s = CKEDITOR.tools.cssLength,
      S =
        '<div class="cke cke_reset_all {editorId} {editorDialogClass}" dir="{langDir}" lang="{langCode}" role="application"><table class="cke_dialog ' +
        CKEDITOR.env.cssClass +
        ' cke_{langDir}" aria-labelledby="cke_dialog_title_{id}" style="position:absolute" role="dialog"><tr><td role="presentation"><div class="cke_dialog_body" role="presentation"><div id="cke_dialog_title_{id}" class="cke_dialog_title" role="presentation"></div><a id="cke_dialog_close_button_{id}" class="cke_dialog_close_button" href="javascript:void(0)" title="{closeTitle}" role="button"><span class="cke_label">X</span></a><div id="cke_dialog_tabs_{id}" class="cke_dialog_tabs" role="tablist"></div><table class="cke_dialog_contents" role="presentation"><tr><td id="cke_dialog_contents_{id}" class="cke_dialog_contents_body" role="presentation"></td></tr><tr><td id="cke_dialog_footer_{id}" class="cke_dialog_footer" role="presentation"></td></tr></table></div></td></tr></table></div>';
      ...
      function j(d, b) {
        ...
        if (!c.getById("cke_pastebin")) {
          var f = a.getSelection(),
            h = f.createBookmarks(),
            i = new CKEDITOR.dom.element(
              e.is("body") && !CKEDITOR.env.ie && !CKEDITOR.env.opera
                ? "body"
                : "div",
              c
            );
          ...
          var o = 0,
            c = c.getWindow();
          j
            ? (i.insertAfter(h[0].startNode), i.setStyle("display", "inline"))
            : (CKEDITOR.env.webkit
                ? (e.append(i),
                  i.addClass("cke_editable"),
                  (o = (
                    e.is("body")
                      ? e
          ...
          (j = i.getParent().isReadOnly())
            ? (i.setOpacity(0), i.setAttribute("contenteditable", !0))
            : i.setStyle(
  ...
  (function () {
    ...
    var e = CKEDITOR.addTemplate(
      ...
      f = CKEDITOR.addTemplate(
        "panel-frame",
        '<iframe id="{id}" class="cke_panel_frame" role="application" frameborder="0" src="{src}"></iframe>'
      ),
  ...
  (function () {
    function p(d, i) {
      this.name = i;
      var a = (this.useIndentClasses =
        d.config.indentClasses && 0 < d.config.indentClasses.length);
      if (a) {
        this.classNameRegex = RegExp(
          "(?:^|\\s+)(" + d.config.indentClasses.join("|") + ")(?=$|\\s)"
        );
        this.indentClassMap = {};
      ...
      this.requiredContent = [
        "p" + (a ? "(" + d.config.indentClasses[0] + ")" : "{margin-left}"),
        "li",
      ];
    }
    function r(d, i) {
      return "ltr" == (i || d.getComputedStyle("direction"))
        ? "margin-left"
        : "margin-right";
    }
    function q(d) {
    ...
    p.prototype = {
      ...
      refresh: function (d, i) {
        ...
        a
          ? this.setState(CKEDITOR.TRISTATE_OFF)
          : !this.useIndentClasses && "indent" == this.name
          ? this.setState(CKEDITOR.TRISTATE_OFF)
          : f
          ? this.useIndentClasses
            ? ((a = f.$.className.match(this.classNameRegex)),
              (f = 0),
              a && ((a = a[1]), (f = this.indentClassMap[a])),
              ("outdent" == this.name && !f) ||
              ("indent" == this.name && f == d.config.indentClasses.length)
                ? this.setState(CKEDITOR.TRISTATE_DISABLED)
                : this.setState(CKEDITOR.TRISTATE_OFF))
            : ((a = parseInt(f.getStyle(r(f)), 10)),
              isNaN(a) && (a = 0),
              0 >= a
                ? this.setState(CKEDITOR.TRISTATE_DISABLED)
                : this.setState(CKEDITOR.TRISTATE_OFF))
      ...
      exec: function (d) {
        function i(n) {
          for (
            var j = l.startContainer, b = l.endContainer;
            j && !j.getParent().equals(n);
          ...
          if (j && b) {
            ...
            if (!(1 > j.length)) {
              ...
              for (
                ...
                if (((a[b].indent += c), 0 < c)) {
                  var k = a[b].parent;
                  a[b].parent = new CKEDITOR.dom.element(
                    k.getName(),
                    k.getDocument()
                  );
                }
              for (
                b = j.getCustomData("listarray_index") + 1;
                b < a.length && a[b].indent > f;
                b++
              )
                a[b].indent += c;
              j = CKEDITOR.plugins.list.arrayToList(
                a,
                o,
                null,
                d.config.enterMode,
              ...
              if ("outdent" == e.name) {
                ...
                if ((i = n.getParent()) && i.is("li"))
                  for (
                    ...
                    (g = c.getItem(b)) && g.is && g.is("li") && h.push(g);
              }
              ...
              if (h && h.length)
                for (b = 0; b < h.length; b++) {
                  for (
                    g = n = h[b];
                    (g = g.getNext()) && g.is && g.getName() in m;

                  )
                    CKEDITOR.env.ie &&
                      !n.getFirst(function (b) {
                        return t(b) && u(b);
                      }) &&
        ...
        function a() {
          ...
          for (
            var b;
            (b = a.getNextParagraph(e == CKEDITOR.ENTER_P ? "p" : "div"));
        ...
        function f(a, g) {
          ...
          if (e.useIndentClasses) {
            ...
            c = Math.max(c, 0);
            a.$.className = CKEDITOR.tools.ltrim(
              a.$.className.replace(e.classNameRegex, "")
            );
        ...
        for (
          ...
          for (
            var h = l.getCommonAncestor();
            h && !(h.type == CKEDITOR.NODE_ELEMENT && m[h.getName()]);
          ...
          h &&
            ...
            l.startContainer.getName() in m &&
            ((k = new CKEDITOR.dom.walker(l)),
            (k.evaluator = q),
            (l.startContainer = k.next()));
          h &&
            l.endContainer.type == CKEDITOR.NODE_ELEMENT &&
            l.endContainer.getName() in m &&
            ((k = new CKEDITOR.dom.walker(l)),
            (k.evaluator = q),
            (l.endContainer = k.previous()));
          if (h) {
            var k = h.getFirst(q),
              w = !!k.getNext(q),
              s = l.startContainer;
    ...
    CKEDITOR.plugins.add("indent", {
      ...
      onLoad: function () {
        (CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat) &&
          CKEDITOR.addCss(
            ".cke_editable ul,.cke_editable ol{\tmargin-left: 0px;\tpadding-left: 40px;}"
          );
      },
      init: function (d) {
        d.blockless ||
          (d.addCommand("indent", new p(d, "indent")),
          d.addCommand("outdent", new p(d, "outdent")),
          d.ui.addButton &&
            ...
            for (var f = new CKEDITOR.dom.walker(a), e; (e = f.next()); )
              if (e.type == CKEDITOR.NODE_ELEMENT)
                if (!e.equals(i.data.node) && e.getDirection()) {
                  ...
                  if (o)
                    for (
                      var g = i.data.dir == "ltr" ? ["_rtl", ""] : ["", "_rtl"],
                        m = 0;
                      m < o.length;
                      m++
                    )
                  ...
                  o
                    ? e.setStyle("margin-left", o)
                    : e.removeStyle("margin-left");
                  g
                    ? e.setStyle("margin-right", g)
                    : e.removeStyle("margin-right");
                }
          }));
      },
    });
          ...
          if (l) {
            ...
            if (!j && !h) {
              ...
              e
                ...
                ? (e = g)
                : ((e = f.createElement(c)),
                  d && (k = d.getDirection()) && e.setAttribute("dir", k));
              if ((f = l.elementPath)) {
                i = 0;
            ...
            : (!i && j && q.test(h)
                ? (j = c.getDirection())
                  ? ((f = f.createElement("div")),
                    ...
                    f.insertAfter(c),
                    b.setStart(f, 0))
                  : (f.createElement("br").insertAfter(c),
                    CKEDITOR.env.gecko && f.createText("").insertAfter(c),
                    b.setStartAt(
                      c.getNext(),
                      CKEDITOR.env.ie
                        ? CKEDITOR.POSITION_BEFORE_START
  ...
  (function () {
    function t(a) {
      ...
      return e in g.$
        ? g.$[e]
        : CKEDITOR.document.$.documentElement[
            "left" == a ? "scrollLeft" : "scrollTop"
          ];
    }
    function p(a) {
      var e,
          ...
          if (r) {
            ...
            if (e) {
              "top" == e && k.top < q
                ...
                : "bottom" == e &&
                  (b.top > o + l ? j("top") : b.bottom > 2 * l + q && j("pin"));
              var c = g.getViewPaneSize(),
                h = c.width / 2,
                h =
                  0 < b.left && b.right < c.width && b.width > k.width
              ...
              CKEDITOR.tools.extend(
                {
                  ...
                  content: n,
                  style:
                    "display:none;z-index:" + (a.config.baseFloatZIndex - 1),
                },
                v
              )
            )
  ...
  (function () {
    function n(a) {
      ...
      b.contentEditable = !0;
      CKEDITOR.env.ie &&
        ((b.hideFocus = !0), (b.disabled = !0), b.removeAttribute("disabled"));
      ...
      CKEDITOR.env.ie &&
        ...
        c.config.enterMode != CKEDITOR.ENTER_P &&
      ...
      try {
        c.document.$.execCommand(
          ...
          !1,
          !c.config.disableNativeTableHandles
        );
      } catch (f) {}
        ...
        this.attachListener(this, "keydown", function (a) {
          ...
          if (b == 33 || b == 34)
            if (CKEDITOR.env.ie)
              ...
              var d = c.createRange();
              d[b == 33 ? "moveToElementEditStart" : "moveToElementEditEnd"](
                this
              );
              d.select();
              a.data.preventDefault();
      ...
      c.document
        ...
        .getItem(0)
        .data("cke-title", c.document.$.title);
    ...
    function o(a) {
      if (!a.readOnly) {
        ...
        if (
          ...
          (1 == f &&
            e.type == CKEDITOR.NODE_ELEMENT &&
            e.hasAttribute("_moz_editor_bogus_node"))
        ) {
          p(a);
          ...
          d.$.dispatchEvent(j);
          (h != g.$.scrollTop || i != g.$.scrollLeft) &&
            e.getWindow().$.scrollTo(i, h);
          f && b.getFirst().remove();
    ...
    CKEDITOR.plugins.add("wysiwygarea", {
      init: function (a) {
        ...
        a.addMode("wysiwyg", function (c) {
          ...
          var f =
              "document.open();" +
              (l ? 'document.domain="' + document.domain + '";' : "") +
              "document.close();",
            f = CKEDITOR.env.air
              ? "javascript:void(0)"
              : CKEDITOR.env.ie
          ...
          var j = CKEDITOR.tools.getNextId(),
            m = CKEDITOR.dom.element.createFromHtml(
              '<span id="' + j + '" class="cke_voice_label">' + i + "</span>"
            );
          e.append(m, 1);
        ...
        proto: {
          setData: function (a, c) {
            ...
            if (c) this.setHtml(a);
              ...
              var h = b.baseHref
                ? '<base href="' + b.baseHref + '" data-cke-temp="1" />'
                : "";
              e &&
                (a = a
              ...
              e
                ...
                : (a =
                    b.docType +
                    '<html dir="' +
                    b.contentsLangDirection +
                    '" lang="' +
                    (b.contentsLanguage || d.langCode) +
                    '"><head><title>' +
                    this._.docTitle +
                    "</title>" +
                    h +
                    g +
                    "</head><body" +
                    (b.bodyId ? ' id="' + b.bodyId + '"' : "") +
                    (b.bodyClass ? ' class="' + b.bodyClass + '"' : "") +
                    ">" +
                    a +
                    "</body></html>");
              CKEDITOR.env.gecko &&
  ...
  (function () {
    ...
    function q(a, b, d) {
      return (b = b[d ? "getPrevious" : "getNext"](function (e) {
        return (
          (e && e.type == CKEDITOR.NODE_TEXT && !y(e)) ||
          (l(e) && !o(e) && !u(a, e))
        );
      }));
    }
        ...
        place: function () {
          ...
          k.equals(b)
            ...
            : ((g.left =
                ...
                e.scroll.x -
                (a.inInlineMode
                  ? e.editable.left + e.editable.border.left
                  : 0)),
              (g.width =
                h.size.outerWidth +
                h.size.margin.left +
          ...
          c.is(w) || (g.top > e.scroll.y - 15 && g.top < e.scroll.y + 5)
            ...
            : c.is(x) ||
              (g.top > e.pane.bottom - 5 && g.top < e.pane.bottom + 15)
            ? ((g.top = a.inInlineMode
                ? e.editable.height +
                  e.editable.padding.top +
                  e.editable.padding.bottom
                : e.pane.bottom - 1),
              this.look(x))
            : (a.inInlineMode &&
                (g.top -= e.editable.top + e.editable.border.top),
              this.look(r));
          a.inInlineMode &&
            (g.top--,
            (g.top += e.editable.scroll.top),
            (g.left += e.editable.scroll.left));
        ...
        look: function (a) {
          if (this.oldLook != a) {
            for (var d = this.lineChildren.length, c; d--; )
              (c = this.lineChildren[d]).setAttribute(
                "style",
      ...
      d.lineChildren[0].on("mouseup", function (b) {
        ...
        K(
          ...
          function (d) {
            ...
            d[c.is(C) ? "insertBefore" : "insertAfter"](
              c.is(C) ? c.lower : c.upper
            );
          },
          !0
        );
    ...
    function K(a, b, d) {
      ...
      n.ie && a.enterMode == CKEDITOR.ENTER_BR
        ...
        : ((c = new J(a.enterBehavior, a.doc)),
          a.enterMode != CKEDITOR.ENTER_BR && a.doc.createText(D).appendTo(c));
            ...
            if (
              ...
              (!q(a, f, !b) || ((c = q(a, f, !b)) && l(c) && c.is(a.triggers)))
                ...
                : ((c = H(a, e)),
                  l(c) &&
                    (q(a, c, !b)
                      ? (e = q(a, c, !b)) && l(e) && e.is(a.triggers) && d(c)
                      : d(c)));
            }
          };
        })(),
    ...
    function U(a) {
      ...
      return !c && 0 <= b.size.top && 0 < d.y && d.y < b.size.top + f
        ? ((a = a.inInlineMode || 0 === e.scroll.y ? w : r),
          new t([null, b, C, F, a]))
        : c &&
    ...
    function M(a, b, d, e) {
      for (
        ...
        (j[s[g]] = parseInt(f("border-" + s[g] + "-width"), 10) || 0),
          (h[s[g]] = parseInt(f("padding-" + s[g]), 10) || 0),
          (i[s[g]] = parseInt(f("margin-" + s[g]), 10) || 0);
      (!d || e) && G(a, e);
    ...
    function m(a, b, d) {
      ...
      if (b.size) {
        if (b.size.ignoreScroll == d && b.size.date > new Date() - Y)
          return null;
      } else b.size = {};
        ...
        a.on(
          ...
          function () {
            ...
            b.is(v.$inline) ||
              ...
              a.addCommand("accessPreviousSpace", R(c)),
              a.addCommand("accessNextSpace", R(c, !0)),
              a.setKeystroke([
      ...
      $ = (function () {
        function a(a) {
          ...
          if (!(a.mouse.y > f.size.top && a.mouse.y < c.size.bottom))
            return null;
          for (
            var e = Number.MAX_VALUE, i, h, k, g;
            c && !c.equals(f) && (h = f.getNext(a.isRelevant));

          )
            (i = Math.abs(ba(a, f, h) - a.mouse.y)),
              i < e && ((e = i), (k = f), (g = h)),
              (f = h),
              m(a, f);
          if (
            !k ||
            !g ||
            !(a.mouse.y > k.size.top && a.mouse.y < g.size.bottom)
          )
            return null;
          j.upper = k;
          j.lower = g;
  ...
  (function () {
    ...
    var i = "",
      r = function () {
        ...
        e.equals = CKEDITOR.tools.override(e.equals, function (a) {
          return function (b) {
            var c = this.contents,
              f = b.contents,
  ...
  (function () {
        ...
        if (d || b) {
          ...
          for (var e = 0; e < d.length; e++) {
            var f = d[e],
              g = b[e];
            if (
              f.startOffset != g.startOffset ||
              f.endOffset != g.endOffset ||
              !CKEDITOR.tools.arrayCompare(f.start, g.start) ||
              !CKEDITOR.tools.arrayCompare(f.end, g.end)
            )
              return !1;
          }
        }
    ...
    i.prototype = {
      ...
      save: function (a, c, d) {
        ...
        if (
          !1 === c.contents ||
          (this.currentImage && c.equals(this.currentImage, a))
        )
          return !1;
      ...
      update: function () {
        this.locked ||
          this.snapshots.splice(
            this.index,
            1,
            (this.currentImage = new h(this.editor))
          );
      },
      lock: function () {
        if (this.locked) this.locked.level++;
          ...
          this.locked = {
            update:
              this.currentImage && this.currentImage.equals(a, !0) ? a : null,
            level: 1,
          };
        }
      },
  ...
  CKEDITOR.config.wsc_customLoaderScript =
    CKEDITOR.config.wsc_customLoaderScript || null;
